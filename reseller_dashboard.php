...
<body>
    <div class="container wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-6"><div class="card"><div class="card-header">Download App</div><div class="card-body">
                <a href="https://web.cornerstone-its-mobiledata.com/download_app.php" class="btn btn-primary"><i class="fab fa-android"></i> Download App</a>
            </div></div></div>
        </div>
